df <- read.csv("C:/Users/nirma/Downloads/WHO-COVID-19-global-data.csv")
df
View(df)
summary(df)
# INSTALL PACKAGES
...
countries <- df %>%
  filter(Country == "Poland" | Country == "Jordan")
############################## Cumulative cases######################################################

ggplot(countries, aes(x = Cumulative_cases, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("cumulative cases of Poland and Jordan")
...
ggplot(countries, aes(x = New_cases, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("New cases of jordan and poland")
...
ggplot(countries, aes(x = Cumulative_deaths, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("cumulative Deaths of Jordan and Poland")
...
ggplot(countries, aes(x = New_deaths, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("New cases of Poland and Jordan")

ggplot(countries, aes(x=ï..Date_reported, y=New_deaths, color = Country, group=1)) +
  geom_line()+
  ggtitle("New deaths of Poland and Jordan")+
  xlab(" Dates")+
  ylab("New Cases")+
  theme_ipsum()
...
countries2020 <- countries %>%
  filter( Ã¯..Date_reported < '2021-01-01')

countries2021 <- countries %>%
  filter( Ã¯..Date_reported < '2022-01-01' & Ã¯..Date_reported > '2020-12-31')

countries2022 <- countries %>%
  filter(Ã¯..Date_reported > '2021-12-31')
...
ggplot(countries2020, aes(x = New_deaths, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("New cases of Poland and Jordan in 2020")


ggplot(countries2020, aes(x=ï..Date_reported, y=Cumulative_deaths, color = Country, group=1)) +
  geom_line()+
  ggtitle("cumulative Deaths of Poland and Jordan in 2020")+
  xlab(" Dates")+
  ylab("New Cases")+
  theme_ipsum()
...
ggplot(countries2020,aes(x=Country, y=Cumulative_cases, fill=Cumulative_cases, color = Country)) +
  ...
  ggtitle("Boxplot of cumulative cases of Jordan and Poland in 2020 ") +
  xlab("")
...
ggplot(countries2021, aes(x = New_deaths, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("New cases of Poland and Jordan in 2021")


ggplot(countries2021, aes(x=ï..Date_reported, y=Cumulative_deaths, color = Country, group=1)) +
  geom_line()+
  ggtitle("cumulative Deaths of Poland and Jordan in 2021")+
  xlab(" Dates")+
  ylab("New Cases")+
  theme_ipsum()
...
ggplot(countries2021,aes(x=Country, y=Cumulative_cases, fill=Cumulative_cases, color = Country)) +
  ...
  ggtitle("Boxplot of cumulative cases of Poland and Jordan in 2021 ") +
  xlab("")


ggplot(countries2021, aes(x = Cumulative_cases, fill = Country))+
  geom_bar(stat="bin")+
  ggtitle("new cases of Jordan and Poland in 2021")
...
ggplot(countries2022, aes(x = New_deaths, fill = Country))+
  geom_histogram(bins = 20)+
  ggtitle("New cases of Poland and Jordan in 2022")


ggplot(countries2022, aes(x=ï..Date_reported, y=Cumulative_deaths, color = Country, group=1)) +
  geom_line()+
  ggtitle("cumulative Deaths of Poland and Jordan in 2022")+
  xlab(" Dates")+
  ylab("New Cases")+
  theme_ipsum()
...
ggplot(countries2022,aes(x=Country, y=Cumulative_cases, fill=Cumulative_cases, color = Country)) +
  ...
  ggtitle("Boxplot of cumulative cases of Poland and Jordan in 2022 ") +
  xlab("")


ggplot(countries2022, aes(x = Cumulative_cases, fill = Country))+
  geom_bar(stat="bin")+
  ggtitle("new cases of saudi Poland and Jordan in 2022")
...
SaudiChinaZambia<-df%>% filter(Country=='Jordan'|Country=='China'| Country == 'Poland')
